...
const AddAgents = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response.data.success) {
        alert("Agent added successful");
        navigate("/login");
      } else {
        alert("Agent added failed");
      }
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <>
      <SideFunction />
      <div className="text-gray-500 bg-gray-100 p-4 sm:ml-64 flex justify-center items-center gap-2 flex-col lg:flex-row translate-all duration-300 mt-14 dark:bg-gray-800">
        <div>
          <div className="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
            <div
              className="bg-violet-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
              style={{ maxWidth: 1000 }}
            >
              <div className="md:flex w-full">
                <div className="hidden md:block w-1/2 bg-violet-600 py-10 px-10">
                  <svg
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="flex -mx-3">
                      <div className="w-1/2 px-3 mb-5">
                        ...
                        <div className="flex">
                          <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <FaRegUser className="text-gray-400 text-lg size-5" />
                          </div>
                          <input
                            type="text"
                            value={name}
                      ...
                      <div className="w-1/2 px-3 mb-5">
                        ...
                        <div className="flex">
                          <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <MdAddIcCall className="text-gray-400 text-lg size-5" />
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-5">
                        ...
                        <div className="flex">
                          <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <SiMinutemailer className="text-gray-500 size-5 text-lg" />
                          </div>
                          <input
                            type="email"
                            value={email}
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-4">
                        ...
                        <div className="flex">
                          <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <TbPasswordMobilePhone className="text-gray-400 text-lg size-5" />
                          </div>
                          <input
                            type="password"
                            required
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-3">
                        ...
                        <div className="flex">
                          <div className="w-10  text-center flex items-center justify-start"></div>
                          <textarea
                            type="text"
                            value={address}
